...
class ApiClient {
    ...
    async getRuntimeLiveSessions(params) {
        ...
        const url = `${this.apiUrl}/api/v1/runtime/live-sessions${query ? `?${query}` : ''}`;
        return this.makeRequest(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
    ...
    async getRuntimeControlPlaneApprovals(params) {
        const queryParams = new URLSearchParams();
        if (typeof params?.limit === 'number' && Number.isFinite(params.limit) && params.limit > 0) {
            queryParams.set('limit', String(Math.floor(params.limit)));
        }
        ...
        const query = queryParams.toString();
        const url = `${this.apiUrl}/api/v1/runtime/approvals${query ? `?${query}` : ''}`;
        return this.makeRequest(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
    ...
    async getRuntimeEvidenceSummary(params) {
        ...
        if (params?.repoKey)
            queryParams.set('repoKey', params.repoKey);
        const query = queryParams.toString();
        const url = `${this.apiUrl}/api/v1/runtime/evidence/summary${query ? `?${query}` : ''}`;
        return this.makeRequest(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
    ...
    async getRuntimeOperationsStatus() {
        const url = `${this.apiUrl}/api/v1/runtime/operations/status`;
        return this.makeRequest(url, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
